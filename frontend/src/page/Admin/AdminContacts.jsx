...
const AdminContacts = () => {
  ...
  const handleStatusUpdate = async (newStatus) => {
    try {
      await axios.put(
        `http://localhost:3000/api/contact/${selectedContact.id}`,
        { status: newStatus },
        { withCredentials: true }
      );
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-blue-100 text-green-800 rounded hover:bg-green-200"
                >
                  완료
                </button>
              </div>
